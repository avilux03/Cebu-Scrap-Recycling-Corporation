  ...
  return (
    <div
      ...
      style={{
        ...
        border: hovered ? "1.5px solid rgba(160,241,189,0.4)" : "1.5px solid rgba(46,79,33,0.12)",
        opacity: inView ? 1 : 0,
        transform: inView
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundColor: hovered ? "rgba(160,241,189,0.12)" : "rgba(46,79,33,0.06)",
          boxShadow: hovered
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {materials.map((material, i) => (
            <MaterialCard key={material.title} {...material} index={i} />
          ))}
        </div>
